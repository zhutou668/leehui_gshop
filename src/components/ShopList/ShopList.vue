            ...
            <div class="shop_list_content_header">
                <div class="shop_list_info">
                    ...
                    <p class="shop_list_info_evaluate">
                        ...
                        <span class="shop_list_info_vote">{{
                            shop.rating
                        }}</span>
                        <span class="shop_list_info_sell"
                            >月售{{ shop.recent_order_num }}单</span
                        >
                    </p>
                    <p class="shop_list_info_condition">
                        <span class="shop_list_info_minium"
                            >&#165;{{
                ...
                <div class="shop_list_mark">
                    <p class="shop_list_mark_title">
                        <span
                            class="shop_list_mark_text"
                            v-for="(support, index) in shop.support"
                            :key="index"
                            >{{ support.icon_name }}</span
                        >
                    </p>
                    <p class="shop_list_mark_title">
                        <span class="shop_list_mark_content">{{
